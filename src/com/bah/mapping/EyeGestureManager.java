...
public class EyeGestureManager {
	...
	public static abstract interface Listener {
		...
		public abstract void onEnableStateChange(EyeGesture paramEyeGesture,
	...
	public boolean enableDetectorPersistently(EyeGesture paramEyeGesture,
			boolean paramBoolean) {
		return false;
	}
	...
	public boolean isRegistered(EyeGesture paramEyeGesture,
	...
	public boolean registerOneShot(EyeGesture paramEyeGesture,
			Listener paramListener) {
		return false;
	}
	...
	public boolean startDetector(EyeGesture paramEyeGesture,
			boolean paramBoolean) {
		return false;
	}
